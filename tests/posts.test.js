...
describe('Posts endpoints', () => {
  ...
  test('GET /posts/:id should return 400 for invalid ID', async () => {
  ...
  test('POST /posts should return 400 if required fields are missing', async () => {
    ...
    expect(response.body.error)
      .toBe('Title, content and author_id are required');

  });

  test('POST /posts should return 400 if author does not exist', async () => {
